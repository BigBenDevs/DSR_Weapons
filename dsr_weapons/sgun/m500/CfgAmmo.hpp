...
{
	class BulletBase;
	class 12Guage_Slug: BulletBase
	{
		hit = 20;indirectHit = 0;indirectHitRange = 0; /// seems like standard 6.5mm round
		cartridge = "FxCartridge_slug"; /// seems like standard 6.5mm round
		visibleFire = 6; /// how big does the shooter seem to be for AI to take notice after he shoots
		audibleFire = 10; /// how big does the shooter seem to be for AI to take notice after he shoots
