...
class CfgWeapons
{
	...
	class DSR_Weapons_Arifle_M4_300_Base: Rifle_Base_F /// Just basic values common for all testing rifle variants
	{
		magazines[] = {30Rnd_762x35mm_300_ACC_FMJ_mag,30Rnd_762x35mm_300_ACC_OT_mag,30Rnd_762x35mm_300_ACC_FMJ_Tracer,30Rnd_762x35mm_300_ACC_OT_Tracer}; /// original custom made magazines and a group of several standardized mags
		...
		class WeaponSlotsInfo: WeaponSlotsInfo
		{
			class MuzzleSlot: MuzzleSlot
			{
				...
				compatibleItems[] = {"300_suppressor"}; 				/// A custom made suppressor for this weapon
...
/////////////////////////////////////////////////////  I R O N S I G H T S  /////////////////////////////////////////////////////
		...
		distanceZoomMax = 300;
/////////////////////////////////////////////////////  I R O N S I G H T S  /////////////////////////////////////////////////////
		descriptionShort = "M4-300 Blackout"; /// displayed on mouseOver in Inventory
		handAnim[] = {"OFP2_ManSkeleton", "dsr_weapons\arifle\m4a3\data\anims\propergrip.rtm"}; /// M16 Hand Animation
		dexterity = 1.8;
		description = "An M4-300 Blackout with rail system and iron sights.";
		scope = 2;
		scopeCurator = 2;
...
//caseless ammo//
    ...
    ////////////////////////////////////////////////////// NO OPTICS ///////////////////////////////////////////////////////////
		class Single: Mode_SemiAuto /// Pew
		{
			...
			class StandardSound: BaseSoundModeType
			{
				begin1[]=
				{
					"dsr_weapons\arifle\m4300\sounds\Enfield_3",
					2.5118864,
					1,
					1400
				};
	...
	class DSR_Arifle_M4_300: dsr_weapons_arifle_m4_300_base
	{
		scope = 2; /// should be visible and useable in game
		displayName = "M4 Blackout .300 BLK"; /// some name
		model = "\dsr_weapons\arifle\m4300\dsr_m4_300.p3d"; /// path to model
