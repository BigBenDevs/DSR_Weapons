...
class CfgWeapons
{
	...
	class DSR_Weapons_Arifle_FnFal_Base: Rifle_Base_F /// Just basic values common for all testing rifle variants
	{
		magazines[] = {30Rnd_762x51_M80A1_Mag,30Rnd_762x51_M80A1_Mag_Tracer}; /// original custom made magazines and a group of several standardized mags
...
/////////////////////////////////////////////////////  I R O N S I G H T S  /////////////////////////////////////////////////////
		...
		descriptionShort = "FnFal 7.62"; /// displayed on mouseOver in Inventory
		handAnim[] = {"OFP2_ManSkeleton", "dsr_weapons\arifle\m4a3\data\anims\propergrip.rtm"}; /// M16 Hand Animation
		dexterity = 1.8;
		description = "FnFal with Iron Sights";
		scope = 2;
		scopeCurator = 2;
...
// Finished here
    ...
    //////////////////////////////////////////////////// OPTICS //////////////////////////////////////////////////
		...
		reloadMagazineSound[]={"dsr_weapons\arifle\fnfal\data\sounds\FAL_reload",db-8,1, 30}; /// custom made sounds
	};

	class DSR_Arifle_FnFal: dsr_weapons_arifle_fnfal_base
	{
		scope = 2; /// should be visible and useable in game
		displayName = "FnFal (Not Currently Used)"; /// some name
		model = "\dsr_weapons\arifle\fnfal\dsr_fnfal.p3d"; /// path to model

		picture = "\dsr_weapons\arifle\fnfal\data\ui\fnfal_ca.paa"; /// different accessories have M, S, T instead of X
