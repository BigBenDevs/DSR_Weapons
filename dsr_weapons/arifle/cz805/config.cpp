...
class CfgPatches
{
	class dsr_weapons_cz805_az
	{
		units[]={};
		weapons[]={"dsr_cz805_a2"};
		requiredVersion=0.1;
...
class CfgWeapons
{
	...
	class DSR_Weapons_Arifle_CZ805_A2_Base: Rifle_Base_F /// Just basic values common for all testing rifle variants
	{
...
//caseless ammo//
	...
	class DSR_Arifle_CZ805_A2: DSR_Weapons_Arifle_CZ805_A2_Base
	{
		scope = 2; /// should be visible and useable in game
		displayName = "CZ805 5.56 mm"; /// some name
