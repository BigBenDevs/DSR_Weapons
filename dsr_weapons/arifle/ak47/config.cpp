...
class CfgWeapons
{
	...
	class DSR_Weapons_Arifle_ak47_Base: Rifle_Base_F /// Just basic values common for all testing rifle variants
	{
		magazines[] = {30Rnd_762x39_mag,30Rnd_762x39_mag_tracer}; /// original custom made magazines and a group of several standardized mags
...
/////////////////////////////////////////////////////  I R O N S I G H T S  /////////////////////////////////////////////////////
		...
		descriptionShort = "ak47 7.62x39mm"; /// displayed on mouseOver in Inventory
		handAnim[] = {"OFP2_ManSkeleton", "dsr_weapons\arifle\m4a3\data\anims\propergrip.rtm"}; /// M16 Hand Animation
		dexterity = 1.8;
		description = "An AK Variant with iron sights.";
		scope = 2;
		scopeCurator = 2;
...
// Finished here
	...
	class DSR_Arifle_AK47: dsr_weapons_arifle_ak47_base
	{
		scope = 2; /// should be visible and useable in game
		displayName = "AK47"; /// some name
		model = "\dsr_weapons\arifle\ak47\dsr_ak47.p3d"; /// path to model
