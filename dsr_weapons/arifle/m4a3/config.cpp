...
class CfgWeapons
{
	...
	class DSR_Weapons_Arifle_M4A3_Base: Rifle_Base_F /// Just basic values common for all testing rifle variants
	{
...
//caseless ammo//
    ...
    ////////////////////////////////////////////////////// NO OPTICS ///////////////////////////////////////////////////////////
		...
		class Single: Mode_SemiAuto /// Pew
		{
			...
			class StandardSound: BaseSoundModeType
			{
				begin1[]=
				{
					"A3\Sounds_F\weapons\sdar\sdar_st_1b",
					1.5118864,
					1,
					1400
				};
				begin2[]=
				{
					"A3\Sounds_F\weapons\sdar\sdar_st_2b",
					1.5118864,
					1,
					1400
				};
				begin3[]=
				{
					"A3\Sounds_F\weapons\sdar\sdar_st_3b",
					1.5118864,
					1,
					1400
				};
    ...
    //////////////////////////////////////////////////// OPTICS //////////////////////////////////////////////////
		...
		reloadMagazineSound[]={"dsr_weapons\arifle\m4a3\data\sounds\m4_reload",db-8,1, 30}; /// custom made sounds
	};

	class DSR_Arifle_M4A3: dsr_weapons_arifle_m4a3_base
	{
		scope = 2; /// should be visible and useable in game
		displayName = "M4A3 5.56 mm"; /// some name
